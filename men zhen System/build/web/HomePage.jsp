...
<left><a class="btn btn-default form-inline" href="http://localhost:8084/men_zhen_System/HomePage2.jsp" role="button">退出登录</a></left>
<h1 class="text-left"><strong>门诊管理系统</strong></h1>
<p class="text-left text-muted"><strong>欢迎您使用</strong></p>
<!--    text-muted效果是使文字减弱-->
...
<div >
 ...
 <form class="form-inline">
  ...
  <div class=" btn-group " role="group">
    <button type="button" class="btn btn-primary">提交处方</button>
  </div>
